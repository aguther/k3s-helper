...
multipass transfer ./k8s-dashboard/image-kubernetes-dashboard.tar.gz k3s:/tmp/dashboard/image-kubernetes-dashboard.tar.gz

# unzip image
multipass exec k3s -- gunzip /tmp/dashboard/image-kubernetes-dashboard.tar.gz
# load image
multipass exec k3s -- sudo ctr images import /tmp/dashboard/image-kubernetes-dashboard.tar
